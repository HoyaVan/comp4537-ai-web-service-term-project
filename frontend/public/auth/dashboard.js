...
window.viewResults = async function (roundId) {
  ...
  console.log("results.winner.spotifyId: ", results.winner.spotifyId);
  console.log("results.winner.title: ", results.winner.title);
  console.log("results.winner.artist: ", results.winner.artist);

  // let spotifyTrack = await apiRequest(
  //   "/api/spotify/search/" + results.winner.title + " " + results.winner.artist
  // );
  // console.log("spotifyTrack: ", spotifyTrack);
  // if (spotifyTrack.ok && spotifyTrack.data.success) {
  //   let spotifyTrackData = spotifyTrack.data.data;
